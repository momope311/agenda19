...
if ($total > 0) {
	...
	$s .= Engine::Pagination($page, $num_page, 'clanci-od-korisnika/'.$opt2);
} else {
...
$cont =
"
<section class='page-section mt-5' id='clanci-od-korisnika'>
<div class='container'>
<div class='text-center'>
<h2 class='page-section-heading text-secondary mb-0 d-inline-block'>Чланци од корисника: $opt2</h2>
</div>
